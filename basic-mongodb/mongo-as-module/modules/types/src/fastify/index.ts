...
export type Body<T = void> = { Body: T };
export type Query<T = void> = { Querystring: T };
export type Params<T = void> = { Params: T };
export type RouterReturn<T = void> = Promise<T | void>;

export type ErrorLevel = 'info' | 'error' | 'debug' | 'fatal' | 'warn' | 'trace' | 'child';
