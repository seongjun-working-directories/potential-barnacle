...
import type { EnterpriseSize, StockMarket, TCBCertificationGrade, TCBCertificationIssuedOrganization, TCBCertificationType, FiStandard } from '.././../information/index';
...
export declare type InvesteeReportTemplateTab = 'tab:companyInfo' | 'tab:keyIndicators' | 'tab:shareStatus' | 'tab:businessStatus';
...
export declare type InvesteeReportTemplate = InvesteeReportTemplateItem[];
...
//# sourceMappingURL=investee.report.d.ts.map